package com.mreader.LG.PoolService;
 ...
 */
public class ImageThreadPool implements ThreadsPoolManager {
    ...
    /** Singleton access */
    public static synchronized ImageThreadPool getInstance() {
        if (instance == null) instance = new ImageThreadPool();
        return instance;
    }
