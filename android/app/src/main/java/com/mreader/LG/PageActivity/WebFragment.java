...
public class WebFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        cookieManager.setAcceptThirdPartyCookies(webBinding.web, true);
        ...
        webViewModel.getReload().observe(getViewLifecycleOwner(), new Observer<Boolean>() {
            @Override
            public void onChanged(Boolean shouldReload) {
                if (shouldReload) {
                    reload();
                }
            }
    ...
    private void setupScrollAwareSearchBar() {
        ...
        webBinding.web.setOnScrollChangeListener((view, scrollX, scrollY, oldScrollX, oldScrollY) -> {
